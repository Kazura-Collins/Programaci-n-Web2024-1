...
export function Body ({ toggleMusic }) {
  ...
  return (
    <div className='container'>
      ...
      <Button handleClick={decrement} text='Restar' className='decrement-button' />
      <Button handleClick={increment} text='Agregar' className='increment-button' />
      <Button handleClick={toggleMusic} text='Activa la música!' className='music-button' />
    </div>
  )
}
